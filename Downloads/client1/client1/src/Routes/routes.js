...
import AddBookingManager from "../Pages/AmbulanceAdmin/BookingManager/AddBookingManager";
import EditBookingManager from "../Pages/AmbulanceAdmin/BookingManager/EditBookingManager";
import AddAmbulance from "../Pages/AmbulanceAdmin/Ambulance/AddAmbulance";
import AddDriver from "../Pages/AmbulanceAdmin/Driver/AddDriver";
import EditDriver from "../Pages/AmbulanceAdmin/Driver/EditDriver";
...
const ambulanceAdminRoutes = [
  ...
  { path: "/private-ambulance/add-booking-manager", component: <AddBookingManager /> },
  { path: "/private-ambulance/edit-booking-manager/:id", component: <EditBookingManagers /> },


  { path: "/private-ambulance/ambulance", component: <Ambulance /> },
  { path: "/private-ambulance/add-ambulance", component: <AddAmbulance /> },
  { path: "/private-ambulance/edit-ambulance/:id", component: <AddAmbulance /> },


  { path: "/private-ambulance/driver", component: <Driver /> },
  { path: "/private-ambulance/add-driver", component: <AddDriver /> },
  { path: "/private-ambulance/edit-driver/:id", component: <EditDriver /> },
