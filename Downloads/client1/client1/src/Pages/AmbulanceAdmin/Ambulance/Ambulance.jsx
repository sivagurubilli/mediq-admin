...
const Ambulance = () => {
  ...
  const handleAdd = () => {
    navigate("/private-ambulance/add-ambulance");
  };

  const handleEdit = () => {
    navigate(`/private-ambulance/edit-ambulance/${editId?._id}`,{
  ...
  return (
    ...
    <div className="text-start mb-2 mt-5 ms-1" style={{ fontWeight: "800" }}>
      <Link to="/admin/dashboard">Dashboard</Link>&nbsp;&#8811;&nbsp; Ambulances
      ...
      <Col xl={12}>
        <Card>
          <Card.Header className="d-flex justify-content-between">
            <Card.Title className="fw-bold fs-5 mt-2">Ambulances</Card.Title>
