...
const HospitalBranches = () => {
  ...
  const handleAdd = () => {
    navigate("/hospitals/add-branches");
  };

  const handleEdit = () => {
    navigate(`/hospitals/edit-branches/${editId?._id}`,{
  ...
  return (
   ...
   <EditModal
    ...
    <div className="text-start mb-2 mt-5 ms-1" style={{ fontWeight: "800" }}>
      <Link to="/admin/dashboard">Dashboard</Link>&nbsp;&#8811;&nbsp;  Branches
      ...
      <Col xl={12}>
        <Card>
          <Card.Header className="d-flex justify-content-between">
            <Card.Title className="fw-bold fs-5 mt-2"> Branches </Card.Title>
