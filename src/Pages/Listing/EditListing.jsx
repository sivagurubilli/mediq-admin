...
formDataToSubmit.append("image", formData.image[0] || '');
 try{
    // Append each property to FormData
      ...
      let response = await LystingService.editListing(formDataToSubmit,id);
      if (response.status === 200) {
        navigate(`/admin/listing/${listingType._id}`);
    ...
    <div className="container mt-5">
       <div
        ...
        >
          ...
          <Link to={`/admin/listing/${listingType?._id}`}>Listing</Link>&nbsp;&#8811; Edit Listing
          </div>
      <Row>
        <Col md={12}>
          <Card>
                ...
                <Row className="d-flex justify-content-center mb-3">
                  ...
                  <Col md={4}>
                    <Form.Group controlId="phone2">
                      <InputGroup>
                        <Form.Control type="tel" placeholder="Enter Phone 2" {...register("phone2")} />
                      </InputGroup>
                    </Form.Group>
                  </Col>
                </Row>
                ...
                <Row className="d-flex justify-content-center mb-3">
                  ...
                  <Col md={4}>
                    <Form.Group controlId="phone3">
                      <InputGroup>
                        <Form.Control type="tel" placeholder="Enter Phone 3" {...register("phone3")} />
                      </InputGroup>
                    </Form.Group>
                  </Col>
                </Row>
