...
const Amenities = () => {
  ...
  const handleAdd = () => {
    navigate("/admin/add-amenities");
  };

  const handleEdit = () => {
    navigate(`/admin/edit-amenities/${editId._id}`,{
  ...
  const getData = async () => {
    try {
      let data = await AmenitiesService.getAmenities();
  ...
  const handleDelete1 = async () => {
    try {
      let data = await AmenitiesService.deleteAmenities({}, deleteId);
      getData();
  ...
  return (
    ...
    <div className="text-start mb-2 mt-5 ms-1" style={{ fontWeight: "800" }}>
      <Link to="/admin/dashboard">Dashboard</Link>&nbsp;&#8811;&nbsp;Ambulance Amenities
      ...
      <Col xl={12}>
        <Card>
          <Card.Header className="d-flex justify-content-between">
            <Card.Title className="fw-bold fs-5 mt-2">Ambulance Amenities</Card.Title>
