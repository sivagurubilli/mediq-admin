...
const Crm = () => {
  ...
  return (
    <Fragment>
      <div className="fs-3 text-start mt-5 mb-2 ms-1">
        ...
        <div className="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
          ...
          <div className="btn-list mt-md-0 mt-2">
            <Button
              variant=""
              type="button"
              className="btn btn-primary btn-wave ms-2"
            >
            ...
            <Button
              variant=""
              type="button"
              className="btn btn-outline-secondary btn-wave ms-2"
            >
                ...
                <Row>
                  <Col xl={12}>
                    <Card className="custom-card crm-highlight-card">
                      <Card.Body>
                        <div className="fw-semibold fs-18 text-white mb-2">
                          Your target is incomplete
                        </div>

                        <div className="d-flex align-items-center justify-content-between">
                          <div className="me-3" style={{ width: "80%" }}>
                            <span className="d-block fs-12 text-white">
